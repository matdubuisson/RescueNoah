...
public class CircularLinkedList<Item> implements Iterable<Item> {
    ...
    public Item remove(int index) {
        this.nOp++;
        Node curNode = this.last, oldNode = null;
    ...
    private class ListIterator implements Iterator<Item> {
        ...
        int index = 0;
        long nOp = CircularLinkedList.this.nOp;
        Node curNode = CircularLinkedList.this.last;

        @Override
        public boolean hasNext() {
            return this.index < CircularLinkedList.this.size();
        }

        @Override
        public Item next() {
            if (this.nOp != CircularLinkedList.this.nOp) {
    ...
    public void print(){
        ...
        Iterator<Item> iterator = new CircularLinkedList.ListIterator();

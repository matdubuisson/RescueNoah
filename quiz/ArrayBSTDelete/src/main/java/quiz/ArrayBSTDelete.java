...
public class ArrayBSTDelete<Key extends Comparable<Key>, Value> {
    ...
    public ArrayList<Boolean> isNotUse;
        ...
        if (!values.isEmpty()) {
            ...
            do {
                ...
                if (cmp == 0) {
                    ...
                    if(this.isNotUse.get(i)){
                        this.isNotUse.set(i, false);
                        return true;
                    }
    ...
    public Value get(Key key) {
        ...
        if (i == NONE || this.isNotUse.get(i)) return null;
        return values.get(i);
    }
    ...
    public boolean delete(Key key) {
        ...
        if(index == NONE || this.isNotUse.get(index)) return false;
        else {
            this.isNotUse.set(index, true);
            return true;
        }
    }

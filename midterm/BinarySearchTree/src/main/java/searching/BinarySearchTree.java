...
public class BinarySearchTree {
    ...
    public static Integer ceil(BSTNode<Integer> root, int value) {
        ...
        else if(cmp < 0) return BinarySearchTree.ceil(root.right, value);
        else {
            Integer tmp = BinarySearchTree.ceil(root.left, value);

            if(tmp == null) return root.key;
            else return tmp;
        }*/
